                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $post->title }}" type="text" name="title" id="inputName" class="form-control">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="inputDescription" class="form-control" rows="4">{{ $post->content }}</textarea>
                                @error('content')
